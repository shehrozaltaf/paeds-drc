        ...
        */
        save: function (e, params) {
            ...
            if (this.options.highlight) {
                var $f = this.$element, $e = $f.parents('tr').find(".editablediv"),
            ...
            console.log(params);
            var idComment = $f.parents('tr').attr('data-idComment');
            var field = $f.parents('tr').find('.field').attr('id');
            $e.html(params.newValue);
            submitComment(params.newValue, field, idComment);
            // $(this).find(".editablediv").html(params.newValue);
            // this.parentElement.tr.getElementsByClassName('editablediv').html(params.newValue);
